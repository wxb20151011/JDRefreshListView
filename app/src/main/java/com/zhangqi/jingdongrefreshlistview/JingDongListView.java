...
public class JingDongListView extends ListView implements AbsListView.OnScrollListener{
	private static final String TAG="JingDongListView";
	...
	private TextView tv_pull_to_refresh_lastTime;
	...
	private void init(Context context) {
		...
		tv_pull_to_refresh_lastTime = (TextView) headerView.findViewById(R.id.tv_pull_to_refresh_last_update_time);
		// 设置最后刷新时间
		tv_pull_to_refresh_lastTime.setText("最后刷新时间: " + getLastUpdateTime());
	...
	public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		Log.d("wxb", "mFirstVisibleItem=" + mFirstVisibleItem );
	}
